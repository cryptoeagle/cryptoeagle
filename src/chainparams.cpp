...
public:
    CMainParams() {
        ...
        nSubsidyHalvingInterval = 28349;

        // Build the genesis block. Note that the output of the genesis coinbase cannot
        // be spent as it did not originally exist in the database.
  
        const char* pszTimestamp = "The Second of March is CryptoEagle's birthday";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1393768800; //nTime
        ...
        assert(hashGenesisBlock == uint256("0x0000010248b180466ebf75cccda187035a9b083d4da913481c58cbbe8b8b8cfa"));
        assert(genesis.hashMerkleRoot == uint256("0x668d9513b6a0cc7f64c4fbc6407b0f4c9cf5ed7b64fce7fc9a97b71358c45445"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        // vSeeds.push_back(CDNSSeedData("CryptoEagle.test", "test.CryptoEagle.org"));
